...
using HousingDB.Interface;
using HousingDB.Models;

namespace HousingDB
{
    public class HousingRepos<TEntity> : IGenericRepos<TEntity> where TEntity : class
    {
        private HousingDBContext context;

        private DbSet<TEntity> dbSet;

        public HousingRepos(HousingDBContext context)
        {
